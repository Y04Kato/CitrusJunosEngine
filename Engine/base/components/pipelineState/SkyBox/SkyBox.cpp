...
void SkyBox::ShaderCompile() {
	vertexShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"project/gamedata/resources/shaders/SkyBox.VS.hlsl", L"vs_6_0");
	assert(vertexShaderBlob != nullptr);
	pixelShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"project/gamedata/resources/shaders/SkyBox.PS.hlsl", L"ps_6_0");
...
void SkyBox::CreateRasterizarState() {
	//全部表示
...
void SkyBox::CreatePipelineStateObject() {
