...
void Scanlines::ShaderCompile() {
	...
	pixelShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"project/gamedata/resources/shaders/Scanlines.PS.hlsl", L"ps_6_0");
	assert(pixelShaderBlob != nullptr);
}

void Scanlines::CreateRootSignature() {
...
void Scanlines::CreateInputLayOut() {
	inputLayoutDesc.pInputElementDescs = nullptr;
	inputLayoutDesc.NumElements = 0;
}

void Scanlines::CreateBlendState() {
	//すべての色要素を書き込む
	//何もなし
...
void Scanlines::CreateRasterizarState() {
	//裏面（時計回り）を表示しない
...
void Scanlines::CreatePipelineStateObject() {
