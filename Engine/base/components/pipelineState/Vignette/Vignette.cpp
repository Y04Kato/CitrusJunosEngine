...
void Vignette::ShaderCompile() {
	...
	pixelShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"project/gamedata/resources/shaders/Vignette.PS.hlsl", L"ps_6_0");
...
void Vignette::CreateInputLayOut() {
	inputLayoutDesc.pInputElementDescs = nullptr;
	inputLayoutDesc.NumElements = 0;
}

void Vignette::CreateBlendState() {
	//すべての色要素を書き込む
	//何もなし
...
void Vignette::CreateRasterizarState() {
	//裏面（時計回り）を表示しない
